...
ext_leg_path=os.path.join("sounds","ext_leg.wav")
...
up_arrow = cv2.imread(os.path.join("poseVideos", "up_arrow.png"), cv2.IMREAD_UNCHANGED)
down_arrow = cv2.imread(os.path.join("poseVideos", "down_arrow.png"), cv2.IMREAD_UNCHANGED)
up_arrow_scale=0.5
